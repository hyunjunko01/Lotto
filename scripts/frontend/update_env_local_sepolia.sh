...
require_env SEPOLIA_ACCOUNT_FACTORY
require_env SEPOLIA_LOTTO_FACTORY
require_env SEPOLIA_ENTRY_TOKEN
require_env SEPOLIA_PAYMASTER

CHAIN_ID="${SEPOLIA_CHAIN_ID:-11155111}"
BUNDLER_URL="${SEPOLIA_BUNDLER_URL:-$SEPOLIA_RPC_URL}"
